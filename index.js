...
app.use(cors({origin: ['https://clicknbit.in', 'https://admin.clicknbit.in', 'https://editor.clicknbit.in', 'https://clicknbit-backend.vercel.app', 'http://localhost:3000']})); // Enable CORS
